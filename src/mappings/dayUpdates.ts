...
import { Pair, Token, HoneyswapDayData, PairDayData, TokenDayData } from '../types/schema'
...
export function updateHoneyswapDayData(event: ethereum.Event): HoneyswapDayData {
  ...
  if (honeyswapDayData === null) {
    ...
    honeyswapDayData.dailySwaps = ZERO_BI
    honeyswapDayData.dailyMints = ZERO_BI
    honeyswapDayData.dailyBurns = ZERO_BI
  }
